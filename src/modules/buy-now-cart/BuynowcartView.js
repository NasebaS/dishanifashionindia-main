...
const RegisterScreen = (props) => {
  ...
  React.useEffect(() => {
    ...
    getuser = async () => {
      ...
      if (user_id === null) {
        ...
        fetch(global.apiurl+'getcartdetails&id=' + userid, {
          method: 'GET'
        })
          .then((response) => response.json())
          .then((responseJson) => {
            console.log("CARTDETAILS",responseJson);
            setProductdata(responseJson.details);
            var productdata_temp = responseJson.details;
            var totalamount = 0;
            // productdata_temp.forEach(function (item) {
            //   var each_value = Number(item.customer_price) + Number(item.product_total_price);
  ...
  const handleSubmitButton = () => {
    ...
    fetch(global.apiurl+"createcartorder", {
      method: "POST",
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
                  ...
                  <View style={styles.itemThreeSubContainer}>
                    ...
                    <View style={styles.itemThreeContent}>
                      ...
                      <View>
                        ...
                        <Text style={styles.Amounttext}> Rs. {Number(item.customer_price) + Number(item.product_total_price)} /-</Text>
                      </View>
                    </View>
                  </View>
                </View>
          ...
          {productdata.map((item) => {
            return (
              <View style={styles.avatarContainer}>
                <Image
                  style={styles.avatar}
                  source={{uri : global.apiurl+'image/'+item.image}}
                />
                <View style={{ paddingLeft: 15 }}>
                  ...
                  <Text style={styles.rate}>Rs. {item.mrp_price}/- </Text>
                </View>
              </View>
            );
          })}
      ...
      <View style={styles.demoButtonsContainer}>
        {/* <View style={styles.subtotbg}>
          <View style={styles.subtotcont}>
            ...
            <Text style={styles.pricerate}> Rs. {total}/- </Text>
          </View>
          <View style={styles.subtotcont}>
          ...
          <View style={styles.subtotcont}>
            ...
            <Text style={styles.pricerate}> Rs.{total + 100}/- </Text>
          </View>
        </View> */}
                ...
                {deliverycharges != null ? (
                  <View style={styles.subtotbg}>
                    ...
                    <View style={styles.subtotcont}>
                      ...
                      {(TotalQuantity >= discountFrom) ? (
                        <Text style={styles.pricerate}> Rs.{Number(total) + Number(deliverycharges) - (Number(discountPrice) * Number(TotalQuantity))}/- </Text>
                        ): <Text style={styles.pricerate}> Rs.{Number(total) + Number(deliverycharges)}/- </Text> }
                    </View>
                  </View>
                ): null}
